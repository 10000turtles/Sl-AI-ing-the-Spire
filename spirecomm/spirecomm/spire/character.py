...
class Monster_Action:
    ...
    id_map = {
        ...
        "Acid Slime (L)": {"Corrosive Spit": 1, "Lick": 4, "Tackle": 2},
...
class Move:
    ...
    monster_move_data = {
        ...
        ("Acid Slime (L)", Monster_Action.id_map["Acid Slime (L)"]["Corrosive Spit"]): (11, 0, 0, [], [], [("Slimed", 1)]),
        ("Acid Slime (L)", Monster_Action.id_map["Acid Slime (L)"]["Lick"]): (0, 0, 0, [], [("Weak", 2)], []),
        ("Acid Slime (L)", Monster_Action.id_map["Acid Slime (L)"]["Tackle"]): (16, 0, 0, [], [], []),
        ...
        ("Flame Barrier", 0): (0, 12, 0, [("Flame Barrier", 4)], [], []),
        ...
        ("Strike+", 0): (9, 0, 1, [], [], []),
        ("Defend+", 0): (0, 8, 0, [], [], []),
        ("Bash+", 0): (10, 0, 1, [], [("Vulnerable", 3)], []),
        ("Anger+", 0): (8, 0, 1, [], [], [("Anger", 2)]),
        # ("Armaments+",0) : (0,0,0,[],[],[])
        # ("Body Slam+",0) : (0,0,0,[],[],[])
        # ("Clash+",0) : (0,0,0,[],[],[])
        # ("Cleave+",0) : (0,0,0,[],[],[])
        ("Clothesline+", 0): (14, 0, 1, [], [("Weakness", 3)], []),
        ("Flex+", 0): (0, 0, 0, [("Strength", 4), ("Strength Down", 4)], [], []),
        # ("Havoc+",0): (0,0,0,[],[],[]),
        # ("Headbutt+",0): (9,0,1,[],[],[]),
        # ("Heavy Blade+",0): (14,0,1,[],[],[]),
        ("Iron Wave+", 0): (7, 7, 1, [], [], []),
        ...
        ("Twin Strike+", 0): (7, 0, 2, [], [], []),
        # ("Warcry+",0): (0,0,0,[],[],[]),
        ("Wild Strike+", 0): (17, 0, 1, [], [], [("Wound", 0)]),
        # ("Battle Trance+",0):(0,0,0,[],[],[]),
        # ("Blood for Blood+",0):(18,0,1,[],[],[]),
        # ("Bloodletting+",0):(0,0,0,[],[],[]),
        # ("Burning Pact+",0):(0,0,0,[],[],[]),
        # ("Carnage+",0) : (20,0,1,[],[],[]),
        ("Combust+", 0): (0, 0, 0, [("Combust", 7)], [], []),
        ("Dark Embrace+", 0): (0, 0, 0, [("Dark Embrace", 2)], [], []),
        ("Disarm+", 0): (0, 0, 0, [], [("Strength", -3)], []),
        # ("Dropkick+",0):(5,0,1,[],[],[]),
        # ("Dual Wield+",0):(0,0,0,[],[],[]),
        # ("Entrench+",0) : (0,0,0,[],[],[]),
        ("Evolve+", 0): (0, 0, 0, [("Evolve", 2)], [], []),
        ("Feel No Pain+", 0): (0, 0, 0, [("Feel No Pain", 4)], [], []),
        ("Fire Breathing+", 0): (0, 0, 0, [("Fire Breathing", 10)], [], []),
        ("Flame Barrier+", 0): (0, 16, 0, [("Flame Barrier", 6)], [], []),
        ("Ghostly Armor+", 0): (0, 13, 0, [], [], []),
        ("Hemokinesis+", 0): (20, 0, 1, [], [], []),
        # ("Infernal Blade+",0): (0,0,0,[],[],[]),
        ("Inflame+", 0): (0, 0, 0, [("Strength", 3)], [], []),
        # ("Intimidate+",0):(0,0,0,[],[("Weakness",1)],[])
        ("Metallicize+", 0): (0, 0, 0, [("Metalicize", 4)], [], []),
        ("Power Through+", 0): (0, 20, 0, [], [], [("Wound", 1), ("Wound", 1)]),
        ("Pummel+", 0): (2, 0, 5, [], [], []),
        ("Rage+", 0): (0, 0, 0, [("Rage", 5)], [], []),
        # ("Rampage+") : (8,0,1,[],[],[])
        ("Reckless Charge+", 0): (10, 0, 1, [], [], [("Dazed", 0)]),
        ("Rupture+", 0): (0, 0, 0, [("Rupture", 2)], [], []),
        # ("Searing Blow+",0) : (12,0,0,[],[],[]),
        # ("Second Wind+",0) : (0,5,0,[],[],[]),
        # ("Searing Red+",0) : (0,0,0,[],[],[]),
        ("Sentinel+", 0): (0, 8, 0, [], [], []),
        ...
        # ("Shockwave+",0) : (0,0,0,[],[("Weakness",3),("Vulnerable",3)],[]),
        # ("Spot Weakness+",0): (0,0,0,[("Strength",3)],[],[]),
        ("Uppercut+", 0): (13, 0, 1, [], [("Weakness", 2), ("Vulnerable", 2)], []),
        # ("Whirlwind+",0) : (5,0,X,[],[],[]),
        ("Barricade+", 0): (0, 0, 0, [("Barricade", 1)], [], []),
        ("Berserk+", 0): (0, 0, 0, [("Vulnerable", 1), ("Berserk", 1)], [], []),
        ("Bludgeon+", 0): (42, 0, 1, [], [], []),
        ("Brutality+", 0): (0, 0, 0, [("Brutality", 1)], [], []),
        ("Corruption+", 0): (0, 0, 0, [("Corruption", 1)], [], []),
        ("Demon Form+", 0): (0, 0, 0, [("Demon Form", 3)], [], []),
        ("Double Tap+", 0): (0, 0, 0, [("Double Tap", 2)], [], []),
        # ("Exhume+",0):(0,0,0,[],[],[]),
        # ("Feed+",0):(10,0,0,[],[],[]),
        # ("Fiend Fire+",0):(7,0,X,[],[],[]),
        # ("Immolate+",0) : (21,0,1,[],[],[("Burn",2)]),
        # ("Impervious+",0): (0,30,0,[],[],[]),
        ("Juggernaut+", 0): (0, 0, 0, [("Juggernaut", 7)], [], []),
        # ("Limit Break+",0): (0,0,0,[],[],[]),
        # ("Offering+",0): (0,0,0,[],[],[]),
        # ("Reaper+",0): (4,0,0,[],[],[])
