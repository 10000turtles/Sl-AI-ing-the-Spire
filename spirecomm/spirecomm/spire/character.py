    ...
    def execute_move(self, game_state, actor: Character, target: Character, node=None, card_to_play=None):
        ...
        if isinstance(actor, Monster):
            if actor.name == "Hexaghost" and Monster_Action.id_map["Hexaghost"]["Inferno"] == actor.move_id:
                ...
                bronze_orb = Monster("Orb", None, 58, 58, 0, None, False, False, move_id=3)
                ...
                if Monster_Action.id_map["The Collector"]["Spawn"] == actor.move_id:
                    torch_head = Monster("Torch Head", None, 40, 40, 0, None, False, False, move_id=1)
                ...
                dagger = Monster("Dagger", None, 25, 25, 0, None, False, False, move_id=Monster_Action.id_map["Dagger"]["Stab"])
        ...
        if not card_to_play is None:
            ...
            try:
                ...
                for _ in actor.powers[index].amount:
                    game_state.draw_pile.append(Card(*Move.added_card_data["Dazed"]))
